...
| [XDE-98](/XDE/issues/XDE-98) | [getskillpack/registry](https://github.com/getskillpack/registry) | В корневом [`README.md`](https://github.com/getskillpack/registry/blob/main/README.md) раздел **For operators / Для операторов** ведёт на runbook [`REFERENCE_REGISTRY_OPERATIONS_RU.md`](https://github.com/getskillpack/registry/blob/main/docs/REFERENCE_REGISTRY_OPERATIONS_RU.md). |
