...
- Skill **не хранит** PAT: токен задаётся в **окружении** (shell, GitHub Actions secret, ENV процесса адаптера). **Board — одна страница:** [docs/BOARD_PAT_QUICK_RU.md](../../docs/BOARD_PAT_QUICK_RU.md). Подробнее: [docs/PAPERCLIP_SKILL_INSTALL_RU.md](../../docs/PAPERCLIP_SKILL_INSTALL_RU.md) (*«После установки skill: куда указывать PAT»*).
