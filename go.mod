...
// Paperclip workspace: sibling ../skillget-manager (main @ 3cc884a) overrides this require. When publishing: go get github.com/getskillpack/skillget-manager@main && drop replace.
